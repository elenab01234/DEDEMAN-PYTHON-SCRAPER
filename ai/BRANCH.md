...
3. Verificare: `gh repo view elenab01234/DEDEMAN-PYTHON-SCRAPER --json defaultBranch`
...
gh api repos/elenab01234/DEDEMAN-PYTHON-SCRAPER/git/refs -f ref="refs/heads/main" -f sha=$(gh api repos/elenab01234/DEDEMAN-PYTHON-SCRAPER/git/refs/heads/master --jq '.object.sha')

# Schimbă default branch
gh api repos/elenab01234/DEDEMAN-PYTHON-SCRAPER -X PATCH -f default_branch="main"

# Șterge branch-ul master
gh api repos/elenab01234/DEDEMAN-PYTHON-SCRAPER/git/refs/heads/master -X DELETE
```
